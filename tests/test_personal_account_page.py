...
class TestPersonalAccount:
    ...
    def test_go_to_personal_account(self, request, any_driver):
        driver = request.getfixturevalue(any_driver)
        personal_area_page = PersonalAccountPage(driver)
        personal_area_page.go_to_personal_account_with_auth()
