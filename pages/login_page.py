...
class LoginPage(BasePage):
    ...
    def go_to_recovery_page(self):
        self.click_on_element(LoginPageLocator.PERSONAL_ACCOUNT_BUTTON, LoginPageLocator.LAYER_TO_WAIT)
        self.click_on_element(LoginPageLocator.RECOVERY_PASSWORD_BUTTON, LoginPageLocator.LAYER_TO_WAIT)
    ...
    def check_recovery_password(self):
        ...
        self.click_on_element(LoginPageLocator.PASSWORD_RECOVERY_FIELD, LoginPageLocator.LAYER_TO_WAIT)
        self.set_text_to_element(LoginPageLocator.PASSWORD_RECOVERY_FIELD, TestUserData.user_email)
        self.click_on_element(LoginPageLocator.PASSWORD_RECOVERY_BUTTON, LoginPageLocator.LAYER_TO_WAIT)
    ...
    def check_focus_eye_button(self):
        self.click_on_element(LoginPageLocator.EYE_BUTTON, LoginPageLocator.LAYER_TO_WAIT)
